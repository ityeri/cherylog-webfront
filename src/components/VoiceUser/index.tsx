...
export default function VoiceUser(
    ...
    >
        ...
        <div className="flex h-8/10 gap-1">
            <img src={DeafIcon} alt="서버 헤드셋 음소거" className={deaf ? "" : "hidden"}/>
            <img src={MuteIcon} alt="서버 마이크 음소거" className={mute ? "" : "hidden"}/>
            <img src={SelfDeafIcon} alt="헤드셋 음소거" className={selfDeaf ? "" : "hidden"}/>
            <img src={SelfMuteIcon} alt="마이크 음소거" className={selfMute ? "" : "hidden"}/>
        </div>
    </div>
}